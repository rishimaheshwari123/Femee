    ...
    <div className="bg-gray-100 py-10 px-4">
      <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-6 md:p-10">
        ...
        <p className="text-sm md:text-base text-gray-600 mt-3 leading-relaxed">
          ...
          लाई है यह Helping Her Product और Profit, जो आपको बनाए स्वस्थ्य व
          सक्षम। <br />
        ...
        <div className="mt-8 space-y-6">
          <p className="text-gray-800 text-base leading-relaxed">
            ...
            को Plastics "Force बनाने की मुहिम के तहत हम सब साथ मिलकर इस लक्ष्य
            को साकार करेंगे। Femme Cure हमेशा महिलाओं के साथ ईमानदारी और सच्चाई
            के साथ खड़ा रहेगा।
          </p>
          <p className="text-gray-800 text-base leading-relaxed">
